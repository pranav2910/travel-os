...
for r in rows:
    ...
    if r["test_id"] in ("P1-PERSONA-01b", "P1-PERSONA-01c"):
        superseded.add("P1-PERSONA-01")
    # this run: a targeted "-after" row supersedes its "-before" reproduction of the same defect
    if r["test_id"].endswith("-after"):
        superseded.add(r["test_id"][: -len("-after")] + "-before")
