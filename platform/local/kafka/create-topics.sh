...
TOPICS=(travel.intent travel.trip travel.search travel.policy travel.optimization travel.approval travel.order travel.disruption travel.expense travel.demand travel.learning travel.agent travel.finance travel.audit)
