...
public enum TripStatus {
  ...
  private static final Map<TripStatus, Set<TripStatus>> TRANSITIONS =
      Map.ofEntries(
          ...
          Map.entry(PLANNING, EnumSet.of(AWAITING_APPROVAL, APPROVED, CANCELLED, FAILED)),
          ...
          Map.entry(APPROVED, EnumSet.of(BOOKING, AWAITING_APPROVAL, PLANNING, CANCELLED, FAILED)),
